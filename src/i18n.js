...
const STRINGS = {
  ko: {
    ...
    'shop.title': '대장간 · 강화', 'shop.hint': '처치한 도깨비의 골드로 영구 강화 (저장됨)',
    'book.title': '마법서',
    ...
    'tut.3.title': 'ㄱ + ㅗ ㅏ = 과', 'tut.3.detail': '모음을 이어 그리면 복합 모음! ㅗ 다음 ㅏ = ㅘ → \'과\'.',
  ...
  en: {
    ...
    'shop.title': 'Forge · Upgrades', 'shop.hint': 'Spend dokkaebi gold on permanent upgrades (saved)',
    ...
    'tut.3.title': 'ㄱ + ㅗ ㅏ = 과 (gwa)', 'tut.3.detail': 'Draw vowels in a row for a compound! ㅗ then ㅏ = ㅘ → \'과\'.',
