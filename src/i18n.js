...
const STRINGS = {
  ko: {
    ...
    'banner.stage': '{n}/{m} 관문', 'region.chapter': '새 지역',
    'region.clear': '{name} 클리어!',
    'region.reward': '보상 +{g}₩', 'region.rewardLetter': '보상 +{g}₩ · 새 글자 {j}',
    'region.clearedTitle': '지역 클리어', 'region.newLetter': '새 글자!', 'region.tapContinue': '탭하여 계속',
  ...
  en: {
    ...
    'banner.stage': 'Stage {n}/{m}', 'region.chapter': 'NEW REGION',
    'region.clear': '{name} cleared!',
    'region.reward': 'Reward +{g}₩', 'region.rewardLetter': 'Reward +{g}₩ · new letter {j}',
    'region.clearedTitle': 'Region Cleared', 'region.newLetter': 'new letter!', 'region.tapContinue': 'tap to continue',
